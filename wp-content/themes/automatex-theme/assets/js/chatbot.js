...
function initializeChatbot() {
  ...
  const defaultGreeting = "Hello! I'm the Automatex.ai AI Assistant. How can I help you today?";
  const suggestions = ["What is Automatex.ai?", "View Services", "Contact Support"];

  // Initialize
  const savedMessages = localStorage.getItem("Automatex.ai_chat_history");
  if (savedMessages) {
    try {
  ...
  function resetChat() {
    localStorage.removeItem("Automatex.ai_chat_history");
  ...
  async function handleSend() {
    ...
    localStorage.setItem("Automatex.ai_chat_history", JSON.stringify(messages));
