...
// WordPress-safe jQuery wrapper - fixes $ is not a function error
jQuery(document).ready(function($) {

    // client slider js
    if ($('.clients-silder').length) {
    ...
    // header clients slider
    if ($('#clients-header').length) {
